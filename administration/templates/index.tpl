...
<table border="0" cellpadding="0" cellspacing="0" id="page" style="table-layout: fixed">
	<tr bgcolor="#f6e7a2">
        ...
        <td width="200px" background="./img/logopizza100.png" style="background-repeat:no-repeat; background-position:center"></td>
        <td width="20px"></td>
    ...
    <tr>
        ...
        <td valign="top">
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-size:18px">
                ...
                <tr>
                	<td height="25px" width="8px"><img src="./img/bord-beige1.png" height="25px" alt="" /></td>
                    <td height="25px" class="rouge fond_b"><a href="index.php?page=info" class="rouge">A Propos de nous</a></td>
                    <td height="25px" width="8px"><img src="./img/bord-beige2.png" height="25px" alt="" /></td>
                </tr>
                <tr>
                	<td height="3px" colspan="3"></td>
    ...
    <tr class="fond_v">
    	<td colspan="5" height="40px" align="center"></td>
    </tr>
</table>
